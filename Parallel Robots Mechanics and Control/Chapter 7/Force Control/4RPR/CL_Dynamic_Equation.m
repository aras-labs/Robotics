...
[M_Dynamic_Mats] = FIC_Control(t,X_s,SP,KC,M_Dynamic_Mats,P_Dynamic_Mats) ;

cost = [Xdot ; 
    inv(M_Dynamic_Mats.M)* ...
    (M_Dynamic_Mats.F-M_Dynamic_Mats.C*Xdot-M_Dynamic_Mats.G);
    M_Dynamic_Mats.Fm; M_Dynamic_Mats.Fd ] ;
