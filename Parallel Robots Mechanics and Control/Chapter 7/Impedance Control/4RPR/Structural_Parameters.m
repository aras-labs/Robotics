...
SP.noise_F  = 1e+0*[1;1;0]*0;               % Force    measurement noise
...
Fout=[
     0       0         0       0
    50       0         0       0
    50.001   1000      1000    1000
    75       1000      1000    1000
    75.001   1000      1000    1000
    150      1000      1000    1000
...
SP.Ke = 1e3*diag([1 1 0]);   % Environment stiffness coefficient
SP.Ce = 1e3*diag([1 1 0]);   % Environment damping coefficient


%% Controller Parameters
    
SP.Kd=100*diag([1 1 1]); % The desired impedance stiffness matrix
SP.Cd=20*diag([1 1 1]); % The desired impedance damping matrix
SP.Md=100*diag([1 1 1]); % The desired impedance Mass matrix
