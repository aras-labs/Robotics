...
SP.pert=  1.0; % Parameter perturbation 100%
...
%% Noise Amplitude
SP.noise_x  = 1e-4*[100;100;45*deg2rad]*0;  % no noise
SP.noise_dx = 1e-4*[2;2;0.02]*0;
...
SP.KP=1e4*diag([1 1 100]); % The proportional controller gain KP
SP.KV=1e4*diag([1 1 100]); % The  derivative  controller gain KV
