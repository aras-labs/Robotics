...
SP.KP=1e3*diag([1 1 1 20 20 20]); % The proportional controller gain KP
SP.KV=2e2*diag([1 1 1 1 1 1]); % The derivative controller gain KV
...
SP.time=Fout(:,1);   
SP.Fd=Fout(:,2:7)*0 % No disturbance %*1e4;    % 10KN disturbance!
%% Determine Time Span
SP.ts = 0 ;
SP.tf = 2 ;
