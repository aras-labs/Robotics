...
figure(4)
subplot(231)
plot(t,JF(1,:)/1000,t,PD(1,:)/1000,'--', t,FL(1,:)/1000,'-.'), grid on
xlabel('time(sec)')
ylabel('KN')
title('Actuator Forces \tau_1');
legend('Total', 'PD', 'FL','Location', 'Best')

subplot(232)
plot(t,JF(2,:)/1000,t,PD(2,:)/1000,'--', t,FL(2,:)/1000,'-.'), grid on
xlabel('time(sec)')
ylabel('KN')
title('Actuator Forces \tau_2');

subplot(233)
plot(t,JF(3,:)/1000,t,PD(3,:)/1000,'--', t,FL(3,:)/1000,'-.'), grid on
xlabel('time(sec)')
ylabel('KN')
title('Actuator Forces \tau_3');

subplot(234)
plot(t,JF(4,:)/1000,t,PD(4,:)/1000,'--', t,FL(4,:)/1000,'-.'), grid on
xlabel('time(sec)')
ylabel('KN')
title('Actuator Forces \tau_4');

subplot(235)
plot(t,JF(5,:)/1000,t,PD(5,:)/1000,'--', t,FL(5,:)/1000,'-.'), grid on
xlabel('time(sec)')
ylabel('KN')
title('Actuator Forces \tau_5');

subplot(236)
plot(t,JF(6,:)/1000,t,PD(6,:)/1000,'--', t,FL(6,:)/1000,'-.'), grid on
xlabel('time(sec)')
ylabel('KN')
