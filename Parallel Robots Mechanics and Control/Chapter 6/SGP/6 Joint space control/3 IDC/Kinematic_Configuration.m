...
%
function [KC] = KCiguration(X,Xdot,SP)
%% E.F. Pose
...
KC.Om_x     = zeros(3,3,SP.n); % Skew-Symmetric Matrix Corresponding to Omega_L
...
for i = 1:SP.n 
    ...
    KC.Om_x(:,:,i) = [ 0      -KC.Omega_L(3,i)     KC.Omega_L(2,i)
                   KC.Omega_L(3,i)    0            -KC.Omega_L(1,i)
                  -KC.Omega_L(2,i)   KC.Omega_L(1,i)      0   ] ;    
    KC.c2(:,i) = KC.l(:,i) - SP.cp2(:,i) ;
    KC.mc(:,i) = (1/KC.l(:,i)^2)*(SP.m1(:,i)*SP.c1(:,i)^2+SP.m2(:,i)*KC.c2(:,i)^2) ;
    KC.mg(:,i) = (1/KC.l(:,i))*(SP.m1(:,i)*SP.c1(:,i)+SP.m2(:,i)*KC.c2(:,i)) ;
    KC.mco(:,i) = (1/KC.l(:,i))*SP.m2(:,i)*KC.c2(:,i)-(1/KC.l(:,i)^2)*SP.Ixx(:,i)-KC.mc(:,i) ;
end
