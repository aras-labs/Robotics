...
%   Copyright ARAS @2023
%
%   This function initializes the requires parameters of the 
...
SP.xd=[
        0    90*deg2rad   -90*deg2rad   45*deg2rad
        2    60*deg2rad   -80*deg2rad   45*deg2rad
        4    60*deg2rad   -80*deg2rad   45*deg2rad
        7    0*deg2rad      0*deg2rad   0*deg2rad
...
SP.Ki=0e1*diag([1 2 0.2]); % The  integral controller gain Ki

% Note that the stiffness controller gains are much smaller than 
